            ...
            {phase === 'loading' && (
              ...
              >
                ...
                <div className="mt-6 space-y-2 w-full max-w-xs text-left">
                  {[
                    { label: 'Analyzing body pose',              done: pollCount >= 1 },
                    { label: 'Fitting garment to your shape',   done: pollCount >= 3 },
                    { label: 'Rendering shadows & fabric flow', done: pollCount >= 5 },
              ...
              <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
                ...
                <div className="flex items-center gap-2 mb-4 p-3 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200/60 dark:border-emerald-700/30">
                  ...
                  <p className="text-xs text-emerald-700 dark:text-emerald-300">
                    Generated by OutfitAI · Result cached — try-on again instantly
                  </p>
                </div>
                <div className="flex gap-3">
